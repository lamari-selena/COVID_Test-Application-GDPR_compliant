...
function CovidTest({ covidtest, fetchCovidTest }) {
    ...
    const handleDelete = () => {
        setLoading(true)
        CovidTestService.delete(covidtest.covidtest_id).then(
            () => {
                fetchCovidTest()
                handleClose()
            },
    ...
    return (
        ...
        <div class="shadow-lg px-4 py-6 w-full bg-white dark:bg-gray-800 relative">
            <p class="text-sm w-max text-gray-700 dark:text-white font-semibold border-b border-gray-200">
                Date du test Covid-19 : {covidtest.covidtest_date}
            </p>
            <div class="flex items-end space-x-6 my-6">
                <p class="text-5xl text-black dark:text-white font-bold">
                    Type : {covidtest.covidtest_type}
                </p>
                <span class="text-green-500 text-xl font-bold flex items-center">

                    {covidtest.covidtest_result}
                </span>
            </div>
            ...
            <div class="dark:text-white">
                <div class="flex items-center pb-2 mb-2 text-sm space-x-12 md:space-x-24 justify-between border-b border-gray-200">
                    ...
                    <div class="flex items-end text-xs">
                        {covidtest.covidtest_valid_duration}
                    </div>
                </div>
                <br/>
                        ...
                        <div className="relative w-auto my-6 mx-auto max-w-3xl">
                            ...
                            <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                                ...
                                <div className="relative p-6 flex-auto">
                                    <p>
                                    Êtes-vous sur de vouloir supprimer ce test ?
                                    </p>
                                </div>
                                {/*footer*/}
